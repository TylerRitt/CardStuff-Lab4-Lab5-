...
namespace Memory
{
    public partial class boardForm : Form
    {
        ...
        {
            InitializeComponent();
            path = System.Environment.CurrentDirectory + "\\..\\..\\..\\Cards\\";
        }
        ...
        private PictureBox GetCard(int i) // dont have to change
        {
        ...
        private string GetCardFilename(int i) // change
        {
            return cards[i].FileName;
        ...
        private bool IsMatch(int index1, int index2)// change
        {
        ...
        // TODO:  students should write this one
        private void ShuffleCards()// chnage
        {
        ...
        private void LoadCard(int i)
        {
            ...
            card.Image = Image.FromFile(/*System.Environment.CurrentDirectory + "\\Cards\\"*/path + GetCardFilename(i));
        }
        ...
        {
            PictureBox card = GetCard(i);
            card.Image = Image.FromFile(path + "black_back.jpg");
        }
